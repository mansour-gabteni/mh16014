<?php /* Smarty version Smarty-3.1.19, created on 2015-07-20 17:52:41
         compiled from "T:\home\m4.ru\www\themes\default-bootstrap\order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:464155acfd2938b193-22358090%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ab273e69680376af79dd3ae5991abb65f9e85582' => 
    array (
      0 => 'T:\\home\\m4.ru\\www\\themes\\default-bootstrap\\order-detail.tpl',
      1 => 1425640160,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '464155acfd2938b193-22358090',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55acfd3879dd28_77842590',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55acfd3879dd28_77842590')) {function content_55acfd3879dd28_77842590($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'T:\\home\\m4.ru\\www\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_function_counter')) include 'T:\\home\\m4.ru\\www\\tools\\smarty\\plugins\\function.counter.php';
if (!is_callable('smarty_modifier_regex_replace')) include 'T:\\home\\m4.ru\\www\\tools\\smarty\\plugins\\modifier.regex_replace.php';
?>
...
<?php $_tmp35=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp34."-".$_tmp35."&amp;id_order=".((string)$_smarty_tpl->tpl_vars['order']->value->id)."&secure_key=".((string)$_smarty_tpl->tpl_vars['order']->value->secure_key)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp37=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp36."-".$_tmp37), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Download this product'),$_smarty_tpl);?>
">
									<?php }?>
...
<?php $_tmp39=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp38."-".$_tmp39."&id_order=".((string)$_smarty_tpl->tpl_vars['order']->value->id)."&secure_key=".((string)$_smarty_tpl->tpl_vars['order']->value->secure_key)), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Download this product'),$_smarty_tpl);?>
"> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_name'], ENT_QUOTES, 'UTF-8', true);?>
 	</a>
									<?php } else { ?>
									<a href="<?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['filename'], ENT_QUOTES, 'UTF-8', true);?>
<?php $_tmp40=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['download_hash'], ENT_QUOTES, 'UTF-8', true);?>
<?php $_tmp41=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp40."-".$_tmp41), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Download this product'),$_smarty_tpl);?>
"> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_name'], ENT_QUOTES, 'UTF-8', true);?>
 	</a>
									<?php }?>
