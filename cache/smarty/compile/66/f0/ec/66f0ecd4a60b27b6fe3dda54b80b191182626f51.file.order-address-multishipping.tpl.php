<?php /* Smarty version Smarty-3.1.19, created on 2015-07-20 17:52:15
         compiled from "T:\home\m4.ru\www\themes\default-bootstrap\order-address-multishipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2311455acfd0f670bc3-66300665%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '66f0ecd4a60b27b6fe3dda54b80b191182626f51' => 
    array (
      0 => 'T:\\home\\m4.ru\\www\\themes\\default-bootstrap\\order-address-multishipping.tpl',
      1 => 1425640160,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2311455acfd0f670bc3-66300665',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55acfd132d0a52_88855604',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55acfd132d0a52_88855604')) {function content_55acfd132d0a52_88855604($_smarty_tpl) {?>
...
<?php $_tmp17=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp18=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp17.$_tmp18), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span></a>
	...
	<p class="address_add submit">
		<a href="<?php ob_start();?><?php echo urlencode('&multi-shipping=1');?>
<?php $_tmp19=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo urlencode($_smarty_tpl->tpl_vars['back']->value);?>
<?php }?><?php $_tmp20=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp19.$_tmp20), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="button button-small btn btn-default"><span><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span></a>
	</p>
