<?php /* Smarty version Smarty-3.1.19, created on 2015-07-20 17:52:59
         compiled from "T:\home\m4.ru\www\themes\default-bootstrap\order-opc-new-account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:932555acfd3b500c15-90592106%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ad81a20480517d791e080e9b02d152043138a92f' => 
    array (
      0 => 'T:\\home\\m4.ru\\www\\themes\\default-bootstrap\\order-opc-new-account.tpl',
      1 => 1425640160,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '932555acfd3b500c15-90592106',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55acfd4dd37523_85592359',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55acfd4dd37523_85592359')) {function content_55acfd4dd37523_85592359($_smarty_tpl) {?><div id="opc_new_account" class="opc-main-block">
...
<?php } else { ?>0<?php }?>" />
 ...
 <sup>*</sup></label>
						<input type="text" class="text form-control validate" id="email" name="email" data-validate="isEmail" value="<?php if (isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&isset($_smarty_tpl->tpl_vars['guestInformations']->value['email'])&&$_smarty_tpl->tpl_vars['guestInformations']->value['email']) {?><?php echo $_smarty_tpl->tpl_vars['guestInformations']->value['email'];?>
<?php }?>" />
					</div>
...
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
							<input type="text" class="text form-control validate" id="company" name="company" data-validate="isName" value="<?php if (isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&isset($_smarty_tpl->tpl_vars['guestInformations']->value['company'])&&$_smarty_tpl->tpl_vars['guestInformations']->value['company']) {?><?php echo $_smarty_tpl->tpl_vars['guestInformations']->value['company'];?>
<?php }?>" />
						</div>
