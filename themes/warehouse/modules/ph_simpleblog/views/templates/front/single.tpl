...
<div itemscope="itemscope" itemtype="http://schema.org/Blog" itemprop="mainContentOfPage">
	<div class="ph_simpleblog simpleblog-single {if !empty($post->featured_image)}with-cover{else}without-cover{/if} simpleblog-single-{$post->id_simpleblog_post|intval}" itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
		...
		<div class="post-featured-image" itemscope itemtype="http://schema.org/ImageObject">
				...
				<a href="{$post->featured_image|escape:'html':'UTF-8'}" title="{$post->title|escape:'html':'UTF-8'}" class="iconncybox" itemprop="contentUrl">
		...
		<div class="post-gallery">
			...
			<a rel="post-gallery-{$post->id_simpleblog_post|intval}" class="iconncybox" href="{$gallery_dir|escape:'html':'UTF-8'}{$image.image|escape:'html':'UTF-8'}.jpg" title="{l s='View full' mod='ph_simpleblog'}"><img src="{$gallery_dir|escape:'html':'UTF-8'}{$image.image|escape:'html':'UTF-8'}.jpg" class="img-responsive" /></a>
			{/foreach}
		</div><!-- .post-gallery -->
...
}(document, 'script', 'iconcebook-jssdk'));
{/literal}
</script>
{/if}
<script>
