					...
					<div class="row"> 
		            	<div class="left-side col-xs-12 col-sm-3">
							...
							<div class="logo">
								...
								{/if}
								<img src="{$img_sup_dir}{$supplier.image|escape:'html':'UTF-8'}-medium_default.jpg" alt="" />
								{if $supplier.nb_products > 0}
									</a>
								{/if}
							</div> <!-- .logo -->
						...
						<div class="right-side col-xs-12 col-sm-4">
			            	<div class="right-side-content">
			                    ...
			                    {if $supplier.nb_products > 0}
			                        <a class="btn btn-outline button exclusive-medium" href="{$link->getsupplierLink($supplier.id_supplier, $supplier.link_rewrite)|escape:'html':'UTF-8'}"><span>{l s='View products'}</span></a>
			                    {/if}
			                </div>
						</div><!-- .right-side -->
					</div>
