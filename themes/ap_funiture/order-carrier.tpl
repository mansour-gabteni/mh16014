		...
		{if !$opc}
				<p class="cart_navigation clearfix">
					...
					{if !$is_guest}
						{if $back}
							<a 
								...
								title="{l s='Previous'}"
								class="button-exclusive btn btn-outline button">
					...
					{if isset($virtual_cart) && $virtual_cart || (isset($delivery_option_list) && !empty($delivery_option_list))}
						<button type="submit" name="processCarrier" class="button btn btn-outline standard-checkout button-medium pull-right">
							<span>
