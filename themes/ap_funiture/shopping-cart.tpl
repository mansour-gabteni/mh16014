...
{else}
								...
								{if $voucherAllowed}
									...
									<form action="{if $opc}{$link->getPageLink('order-opc', true)}{else}{$link->getPageLink('order', true)}{/if}" method="post" id="voucher">
										<fieldset>
											...
											<button type="submit" name="submitAddDiscount" class="button btn btn-outline button-small"><span>{l s='OK'}</span></button>
										</fieldset>
									</form>
									{if $displayVouchers}
							...
							{if $voucherAllowed}
								...
								<form action="{if $opc}{$link->getPageLink('order-opc', true)}{else}{$link->getPageLink('order', true)}{/if}" method="post" id="voucher">
									<fieldset>
										...
										<input type="text" class="discount_name form-control" id="discount_name" name="discount_name" value="{if isset($discount_name) && $discount_name}{$discount_name}{/if}" />
										<input type="hidden" name="submitDiscount" />
										<button type="submit" name="submitAddDiscount" class="button btn btn-outline button-small">
											<span>{l s='OK'}</span>
										</button>
									</fieldset>
								</form>
										...
										<div class="cart_quantity_button clearfix">
											{if $product.minimal_quantity < ($customization.quantity -$quantityDisplayed) OR $product.minimal_quantity <= 1}
												<a
													...
													class="cart_quantity_down btn btn-outline button-minus"
											...
											{else}
												<a
													...
													class="cart_quantity_down btn btn-outline button-minus disabled"
													href="#"
													title="{l s='Subtract'}">
													<span><i class="fa fa-minus"></i></span>
												</a>
											...
											<a
												...
												class="cart_quantity_up btn btn-outline button-plus"
	...
	<p class="cart_navigation clearfix">
		<a
			...
			class="button-exclusive btn button btn-outline"
		...
		{if !$opc}
			<a
				...
				class="button btn btn-outline standard-checkout button-medium pull-right"
