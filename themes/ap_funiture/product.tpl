		...
		<div class="pb-left-column col-xs-12 col-sm-12 col-md-7">
			...
			<div id="image-block" class="clearfix">
				<div class="p-label">
					...
					{/if}
					{if $product->condition == 'best'}
					<div data-placement="right" style="position: absolute;top: 2px;left: 2px;width:90px;height:90px;background-image: url(../img/best.png)"></div>	
					{/if}
					{if $product->condition == 'garaty'}
					<div data-placement="right" style="position: absolute;top: 2px;left: 2px;width:90px;height:90px;background-image: url(../img/garanty.png)"></div>						
					{/if}					
				</div>
				{if $have_image}
				...
				<div id="short_description_block">
					...
					{*{if $product->description}
						<p class="buttons_bottom_block">
							<a href="javascript:{ldelim}{rdelim}" class="button btn btn-outline">
								{l s='More details'}
							</a>
						</p>
					{/if}*}
...
$("#ophone").mask("+7 (999) 999-99-99");
				...
				<div class="box-info-product">
					...
					<div class="product_attributes clearfix">
						...
						<!-- quantity wanted -->
						{*if !$PS_CATALOG_MODE}
						<p id="quantity_wanted_p" class="pull-left"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
					...
					<div class="box-cart box-cart-bottom">
						...
						<a class="add_to_compare btn btn-default buttons_bottom_block" href="{$link->getPageLink('products-comparison')|escape:'html':'UTF-8'}" data-id-product="{$product->id|intval}" title="{l s='Add to compare'}" >
