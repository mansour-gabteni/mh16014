				...
				<div class="product_list grid row">
					{foreach from=$accessories item=accessory name=accessories_list}
						{if ($accessory.allow_oosp || $accessory.quantity_all_versions > 0 || $accessory.quantity > 0) && $accessory.available_for_order && !isset($restricted_country_mode)}
							...
							<div class="product-container no-padding col-xs-12 col-sm-6 col-md-3 col-lg-3 text-center product-block" itemscope itemtype="http://schema.org/Product">
										...
										<div class="product-title">	
											<h5 itemprop="name" class="name">
												<a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{$accessory.name|escape:'html':'UTF-8'}" itemprop="url">
													{$accessory.name|truncate:90:'...':true|escape:'html':'UTF-8'}
												</a>
											</h5>
	...
	<section class="page-product-box">
		...
		<form method="post" action="{$customizationFormTarget}" enctype="multipart/form-data" id="customizationForm" class="clearfix">
			...
			<p id="customizedDatas">
				...
				<button class="button btn btn-outline button button-small" name="saveCustomization">
					<span>{l s='Save'}</span>
				</button>
