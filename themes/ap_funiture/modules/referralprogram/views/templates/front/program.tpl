...
<div class="sheets tab-content">
	...
	<div id="idTab1" class="tab-pane active">
		...
		{if $canSendInvitations}
			...
			<form method="post" action="{$link->getModuleLink('referralprogram', 'program', [], true)|escape:'html':'UTF-8'}" class="std table-responsive">
				...
				<p class="submit">
                    <button type="submit" id="submitSponsorFriends" name="submitSponsorFriends" class="btn btn-outline button button-medium"><span>{l s='Validate' mod='referralprogram'}</span></button>
				</p>
			</form>
		{else}
	...
	{if $pendingFriends AND $pendingFriends|@count > 0}
		...
		<form method="post" action="{$link->getModuleLink('referralprogram', 'program', [], true)|escape:'html':'UTF-8'}" class="std table-responsive">
			...
			<p class="submit">
                <button type="submit" name="revive" id="revive" class="button_large btn btn-outline">{l s='Remind my friend(s)' mod='referralprogram'}</button>
			</p>
		</form>
		{else}
	...
	<div id="idTab3" class="tab-pane table-responsive">
...
<ul class="footer_links clearfix">
	<li class="pull-left">
		<a class="btn btn-outline button button-small" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Back to Your Account' mod='referralprogram'}" rel="nofollow">
		<span><i class="fa fa-user"></i> {l s='Back to Your Account' mod='referralprogram'}</span></a>
	</li>
	<li class="pull-right"><a class="btn btn-outline button button-small" href="{$base_dir}" title="{l s='Home' mod='referralprogram'}"><span><i class="fa fa-home"></i>{l s='Home' mod='referralprogram'}</span></a></li>
</ul>
