...
<form class="box" id="compare_shipping_form" method="post" action="#" >
	<fieldset id="compare_shipping">
		...
		<div id="availableCarriers" style="display: none;" class="table-responsive">
		...
		<p class="SE_SubmitRefreshCard">
            <button class="btn btn-outline button button-small" id="carriercompare_submit" type="button" name="carriercompare_submit">
            	<span>{l s='Update cart' mod='carriercompare'}</span>
            </button>
            <button id="update_carriers_list" type="button" class="btn btn-outline button button-small">
