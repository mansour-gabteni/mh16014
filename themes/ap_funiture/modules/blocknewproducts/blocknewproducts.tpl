...
<div id="new-products_block_right" class="block products_block nopadding">
    ...
    <div class="block_content products-block">
        {if $new_products !== false}
            ...
            <div class="lnk">
                <a href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='All new products' mod='blocknewproducts'}" class="btn btn-outline button button-small"><span>{l s='All new products' mod='blocknewproducts'}</span></a>
            </div>
        {else}
