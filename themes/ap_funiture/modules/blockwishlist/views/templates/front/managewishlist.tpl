...
{if $products}
    {if !$refresh}
        ...
        <p class="submit">
            <a id="showSendWishlist" class="btn btn-outline button button-small" href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' mod='blockwishlist'}">
                            ...
                            <div class="product_infos">
                                ...
                                <div class="wishlist_product_detail">
                                    ...
                                    <p class="form-group">
                                        ...
                                        <select class="form-control grey" id="priority_{$product.id_product}_{$product.id_product_attribute}">
                                ...
                                <div class="btn_action">
                                    <a class="btn btn-outline button button-small" href="javascript:;" onclick="WishlistProductManage('wlp_bought_{$product.id_product_attribute}', 'update', '{$id_wishlist}', '{$product.id_product}', '{$product.id_product_attribute}', $('#quantity_{$product.id_product}_{$product.id_product_attribute}').val(), $('#priority_{$product.id_product}_{$product.id_product_attribute}').val());" title="{l s='Save' mod='blockwishlist'}">
    ...
    {if !$refresh}
        ...
        <a id="hideSendWishlist" class="button_account btn icon"  href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" rel="nofollow" title="{l s='Close this wishlist' mod='blockwishlist'}">
            ...
            <fieldset>
                ...
                {/section}
                <div class="submit">
                    <button class="btn btn-outline button button-small" type="submit" name="submitWishlist"
