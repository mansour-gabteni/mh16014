	...
	<ul class="footer_links clearfix">
		<li class="pull-left">
			<a class="btn btn-outline button button-small" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
				<span>
					<i class="fa fa-user"></i>{l s='Back to Your Account' mod='blockwishlist'}
				</span>
			</a>
		</li>
		<li class="pull-right">
			<a class="btn btn-outline button button-small" href="{$base_dir|escape:'html':'UTF-8'}">
				<span>
					<i class="fa fa-home"></i>{l s='Home' mod='blockwishlist'}
				</span>
			</a>
		</li>
	</ul>
