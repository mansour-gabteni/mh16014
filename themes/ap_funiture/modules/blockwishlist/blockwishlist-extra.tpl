...
{else}
	{foreach name=wl from=$wishlists item=wishlist}
		...
		{/if}
	{foreachelse}
		<a href="#" id="wishlist_button_nopop" class="wishlist_button" onclick="WishlistCart('wishlist_block_list', 'add', '{$id_product|intval}', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="{l s='Add to my wishlist' mod='blockwishlist'}">
			{l s='Add to wishlist' mod='blockwishlist'}
		</a>
	{/foreach}
{/if}
