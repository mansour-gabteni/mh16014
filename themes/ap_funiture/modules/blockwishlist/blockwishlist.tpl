		...
		<div class="lnk">
			{if $wishlists}
				<div class="form-group selector1">
					<select class="form-control" name="wishlists" id="wishlists"  >
			...
			{/if}
			<a class="btn btn-outline button button-small" href="{$link->getModuleLink('blockwishlist', 'mywishlist', array(), true)|escape:'html':'UTF-8'}" title="{l s='My wishlists' mod='blockwishlist'}">
				<span>
