...
<p class="text-center">
	<a class="btn btn-outline" href="{$link->getModuleLink('loyalty', 'default', ['process' => 'transformpoints'], true)|escape:'html':'UTF-8'}" onclick="return confirm('{l s='Are you sure you want to transform your points into vouchers?' mod='loyalty' js=1}');">{l s='Transform my points into a voucher of' mod='loyalty'} <span class="price">{convertPrice price=$voucher}</span>.</a>
</p>
{/if}
...
<ul class="footer_links clearfix">
	<li class="pull-left">
		<a class="btn btn-outline button button-small" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Back to Your Account' mod='loyalty'}" rel="nofollow"><span><i class="fa fa-user"></i>{l s='Back to Your Account' mod='loyalty'}</span></a>
	</li>
	<li class="pull-right">
		<a class="btn btn-outline button button-small" href="{$base_dir}" title="{l s='Home' mod='loyalty'}"><span><i class="fa fa-home"></i>{l s='Home' mod='loyalty'}</span></a>
	</li>
</ul>
