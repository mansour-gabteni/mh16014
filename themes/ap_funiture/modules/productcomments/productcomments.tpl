	...
	<div id="product_comments_block_tab">
		{if $comments}
						...
						<ul>
							...
							{if $is_logged}
								...
								<li>
									...
									<button class="usefulness_btn btn btn-outline button button-small" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">
										<span>{l s='Yes' mod='productcomments'}</span>
									</button>
									<button class="usefulness_btn btn btn-outline button button-small" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">
			...
			<p class="align_center">
				<a id="new_comment_tab_btn" class="btn btn-outline button button-small open-comment-form" href="#new_comment_form">
