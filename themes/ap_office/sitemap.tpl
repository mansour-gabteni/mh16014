...
<div id="sitemap_content" class="row" style="display:none;">
	<div class="col-xs-12 col-sm-6">
		<div class="sitemap_block box" >
    		<h3 class="page-subheading"><span>{l s='Our offers'}</span></h3>
    		<ul>
    			<li>
                    <a 
...
<div id="listpage_content" class="row">
	<div class="col-xs-12 col-sm-6">
		<div class="categTree box">
            <h3 class="page-subheading"><span>{l s='Categories'}</span></h3>
            <div class="tree_top">
    ...
    <div class="col-xs-12 col-sm-6">
		<div class="sitemap_block box">
            <h3 class="page-subheading"><span>{l s='Pages'}</span></h3>
            <ul>
            	<li>
