	...
	{else}
		<form method="post" action="{$action|escape:'html':'UTF-8'}#guestToCustomer" class="std">
			<fieldset class="description_box box">
				...
				<p>
                    <button type="submit" name="submitTransformGuestToCustomer" class="button button-medium btn btn-outline"><span>{l s='Send'}</span></button>
                </p>
			</fieldset>
		</form>
	{/if}
{else}
	...
	<form method="post" action="{$action|escape:'html':'UTF-8'}" class="std" id="guestTracking">
		<fieldset class="description_box box">
			<h2 class="page-heading">{l s='To track your order, please enter the following information:'}</h2>
                    <div class="text form-group">
			...
			<p>
                <button type="submit" name="submitGuestTracking" class="button btn btn-outline button-medium"><span>{l s='Send'}</span></button>
            </p>
		</fieldset>
	</form>
{/if}
