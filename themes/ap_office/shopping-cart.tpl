				...
				{if $delivery->id}
					<div class="col-xs-12 col-sm-6"{if !$have_non_virtual_products} style="display: none;"{/if}>
						<ul id="delivery_address" class="address item box">
							<li><h3 class="page-subheading"><span>{l s='Delivery address'}&nbsp;</span><span class="address_alias">({$delivery->alias})</span></h3></li>
				...
				{if $invoice->id}
					<div class="col-xs-12 col-sm-6">
						<ul id="invoice_address" class="address alternate_item box">
							<li><h3 class="page-subheading"><span>{l s='Invoice address'}&nbsp;</span><span class="address_alias">({$invoice->alias})</span></h3></li>
	...
	<p class="cart_navigation clearfix">
		...
		{if !$opc}
			<a
				...
				class="button btn btn-outline standard-checkout button-medium pull-right btn-sm"
