      ...
      <div class="panelcontent ">
          <div class="panelinner">
            ...
            <div class="group-input clearfix">
              ...
              <div class="col-sm-9">
                <div data-theme-skin-id="default" class="leo-dynamic-theme-skin{if $LEO_DEFAULT_SKIN=='default'} current-theme-skin{/if}">
                    <label>{l s='Default'}</label>
                </div>
                {foreach $skins as $skin}
                <div data-theme-skin-id="{$skin.id}" data-theme-skin-css="{$skin.css}" data-theme-skin-rtl="{$skin.rtl}" class="leo-dynamic-theme-skin{if isset($skin.icon) && $skin.icon} theme-skin-type-img{/if}{if $LEO_DEFAULT_SKIN==$skin.id} current-theme-skin{/if}">
                  {if isset($skin.icon) && $skin.icon}
                    <img src="{$skin.icon}" width="36" height="36" alt="skin {$skin.id}"/>
                  {else}
                    <label class="{$skin.id}">{$skin.name}</label>
                  {/if}
                </div>
                {/foreach}
              </div>
            ...
            <div class="group-input clearfix">
              <label class="col-sm-3 control-label">{l s='Header Style'}</label>
              <div class="col-sm-9">
            ...
            <div class="group-input clearfix">
              <label class="col-sm-3 control-label">{l s='SideBar Menu'}</label>
              <div class="col-sm-9">
            ...
            {if $theme_customizations && isset($theme_customizations.layout) && isset($theme_customizations.layout.layout_mode) && isset($theme_customizations.layout.layout_mode.option)}
              <div class="group-input clearfix">
                <label class="col-sm-3 control-label">{l s='Layout Mod'}</label>
                <div class="col-sm-9">
