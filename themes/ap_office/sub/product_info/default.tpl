{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
			...
			<section class="page-product-box">
				<h3 class="page-subheading"><span>{l s='Volume discounts'}</span></h3>
		...
		{if isset($features) && $features}
			<!-- Data sheet -->
			<section class="page-product-box">
				<h3 class="page-subheading"><span>{l s='Data sheet'}</span></h3>
		...
		{if $product->description}
			<!-- More info -->
			<section class="page-product-box">
				<h3 class="page-subheading"><span>{l s='More info'}</span></h3>
				{if isset($product) && $product->description}
					<!-- full description -->
					<div  class="rte">{$product->description}</div>{/if}
			</section>
			<!--end  More info -->
		{/if}
		<!--HOOK_PRODUCT_TAB -->
		...
		{if isset($accessories) && $accessories}
			...
			<section class="page-product-box">
				...
				<div class="block products_block accessories-block clearfix">
					<h3 class="page-subheading"><span>{l s='Accessories'}</span></h3>
									...
									<div class="product-container  product-block">
											...
											<div class="product-image-container image">
												...
												<div class="action">
													...
													{if isset($quick_view) && $quick_view}
														<a class="quick-view btn-default btn" href="{$accessory.link|escape:'html':'UTF-8'}" rel="{$accessory.link|escape:'html':'UTF-8'}" title="{l s='Quick view'}" >
										...
										<div class="right-block">
													...
													{if isset($accessory.available_for_order) && $accessory.available_for_order && !isset($restricted_country_mode)}
														<div itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="availability">
															{if ($accessory.allow_oosp || $accessory.quantity > 0)}
																<span class="{if $accessory.quantity <= 0}out-of-stock{else}available-now{/if}">
																	<link itemprop="availability" href="http://schema.org/InStock" />{if $accessory.quantity <= 0}{if $accessory.allow_oosp}{$accessory.available_later}{else}{l s='Out of stock'}{/if}{else}{if isset($accessory.available_now) && $accessory.available_now}{$accessory.available_now}{else}{l s='In Stock'}{/if}{/if}
																</span>
											...
											<div class="functional-buttons clearfix">		
												...
												<div class="view">
													<a itemprop="url" class="button btn btn-outline" href="{$accessory.link|escape:'html':'UTF-8'}" title="{l s='View'}">
															<span>{l s='More'}</span>
														</a>
												</div>
											</div>
		...
		{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
			...
			<!--Download -->
			<section class="page-product-box">
				<h3 class="page-subheading"><span>{l s='Download'}</span></h3>
			...
			<!--Customization -->
			<section class="page-product-box">
				<h3 class="page-subheading"><span>{l s='Product customization'}</span></h3>
		...
		<section id="blockpack">
			<h3 class="page-subheading"><span>{l s='Pack content'}</span></h3>
