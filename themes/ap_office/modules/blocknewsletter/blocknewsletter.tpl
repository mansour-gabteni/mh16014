...
<div id="newsletter_block_left" class="block inline">
    <h4 class="title_block">{l s='Sign up for email update on product offers and discounts' mod='blocknewsletter'}</h4>
    ...
    {/if}
        <form action="{$link->getPageLink('index')|escape:'html'}" method="post">
            <div>
                ...
                <input type="submit" value="{l s='sign up' mod='blocknewsletter'}" class="button_mini btn" name="submitNewsletter" />
