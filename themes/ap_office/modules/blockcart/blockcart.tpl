...
<div class="blockcart_top clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if} col-lg-2-4 col-md-4 col-sm-4 col-xs-12">
{/if}
		...
		<div class="media heading">
			...
			<div class="cart-inner media-body">
				<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
					...
					{if $cart_qties} - {/if}<span class="ajax_cart_quantity{if $cart_qties == 0} unvisible{/if}">{$cart_qties}</span>
