<div id="opc_new_account" class="opc-main-block">
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box form-horizontal">
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="login_passwd">{l s='Password'}</label>
					<div class="col-sm-6">
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std form-horizontal" autocomplete="on" autofill="on">
		<fieldset>
        	<div class="box">
                <h3 id="new_account_title" class="page-subheading"><span>{l s='New Customer'}</span></h3>
                <div id="opc_account_choice" class="row">
                    ...
                    <div class="col-xs-12 col-md-6" style="display:none">
                        ...
                        <p class="opc-button">
                            <button type="submit" class="btn btn-outline button button-medium exclusive" id="opc_createAccount"><span>{l s='Create an account'}</span></button>
                        </p>
                    </div>
                </div>
...
{if array_key_exists('optin', $field_required)}
				...
				{/if}
				<h3 class="page-subheading top-indent"><span>{l s='Delivery address'}</span></h3>
				{$stateExist = false}
				{$postCodeExist = false}
				{$dniExist = false}
