...
if (!class_exists('LeoWidgetBase'))
{
	...
	abstract class LeoWidgetBase
	{
		...
		public $name = 'leomanagewidgets';
		public $id_shop = 0;
		public $fields_form = array();
		public $types = array();
		public $module_name = 'leomanagewidgets';
		...
		public function getFormHelper()
		{
			...
			$helper->base_folder = _PS_MODULE_DIR_.$this->module_name.'/views/templates/helpers/form/';
			$helper->show_cancel_button = true;
			$helper->module = $this;
			$helper->name_controller = $this->name;
			$helper->identifier = $this->name;
			$helper->token = Tools::getAdminTokenLite('AdminLeomanagewidgetsWidgets');
			...
			$liveeditorURL = AdminController::$currentIndex.'&edit=1&token='.Tools::getAdminTokenLite('AdminLeomanagewidgetsWidgets');
			...
			$helper->toolbar_btn = array(
				...
				array(
					'desc' => $this->l('Back'),
					'href' => AdminController::$currentIndex.'&token='.Tools::getAdminTokenLite('AdminLeomanagewidgetsWidgets').'&widgets=1&rand='.rand(),
				),
			);
