...
class LeoWidgetFullslider extends LeoWidgetBase
{
	...
	public function renderForm($args, $data)
	{
		...
		if (Tools::getIsset('addleowidgets'))
		{
			$this->fields_form[1]['form']['input'][] = array(
				...
				'name' => 'html',
				'default' => '',
				'html_content' => '<div class="alert alert-info">'.$this->l('Please Click save to input image').'</div>',
			);
		}
		else
		{
			$this->fields_form[1]['form']['input'][] = array(
				...
				'name' => 'slide',
				'lang' => true,
				'selectImg' => Context::getContext()->link->getAdminLink('AdminLeomanagewidgetsImages'),
				'tree' => '',
				'default' => '',
			);
		}
	...
	{
		Context::getContext()->controller->addJs(__PS_BASE_URI__.'modules/'.$this->name.'/assets/script.js', 'all');
		$t = array(
			'img_width' => 1170,
			'img_height' => 400,
			'thumb_width' => 100,
