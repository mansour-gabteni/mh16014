			...
			<div class="item {if $smarty.foreach.mypLoop.first}active{/if}">
				<ul class="product_list grid">
					{foreach from=$products item=product name=products}
						...
						<li class="ajax_block_product product_block {if $columnspage == 5}col-md-2-4 col-lg-2-4{else}col-md-{$scolumn}{/if} col-xs-6 col-sp-12 {if $smarty.foreach.products.first}first_item{elseif $smarty.foreach.products.last}last_item{/if}">
								...
								{if $page_name != 'index'}
									<div class="functional-buttons clearfix">
										...
										{if isset($comparator_max_item) && $comparator_max_item}
											<div class="compare">
												<a class="add_to_compare" href="{$product.link|escape:'html':'UTF-8'}" data-id-product="{$product.id_product}">{l s='Add to Compare' mod='leomanagewidgets'}</a>
											</div>
										{/if}
									</div>
								{/if}
