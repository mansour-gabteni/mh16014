...
<div class="widget-twitter block">
	...
	<div class="block_content">
		<div id="leo-twitter{$twidget_id}" class="leo-twitter">
			<a class="twitter-timeline" data-dnt="true"  data-theme="{$theme}" data-link-color="{$link_color}" width="{$width}px" height="{$height}px" data-chrome="{$chrome}" data-border-color="{$border_color}" lang="{$iso_code}" data-tweet-limit="{$count}" data-show-replies="{$show_replies}" href="https://twitter.com/{$username}"  data-widget-id="{$twidget_id}"  >Tweets by @{$username}</a>
			{$js}
		</div>	
	</div>
</div>
