			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-body">
						...
						<div class="form-group">
							<label class="control-label col-lg-3">{l s='Row background width' mod='iqitmegamenu'}</label>
							<div class="col-lg-9">
							<select class="select-row-bgw">
								...
								<option value="1" {if isset($node.row_s.bgw) && $node.row_s.bgw==1}selected{/if}>{l s='Force full width' mod='iqitmegamenu'}</option>
						</select>
						<p class="help-block">
								{l s='Enable force full width option only if you not using columns(left, right) on homepage' mod='iqitmegamenu'}
							</p>
					</div></div>
