...
if (!defined('_PS_VERSION_'))
  ...
  class egormprod extends Module
  {
	...
	private function chengeProductPrice($url, $ff)
	{
		...
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);   // âîçâğàùàåò âåá-ñòğàíèöó
		curl_setopt($ch, CURLOPT_HEADER, 0);           // íå âîçâğàùàåò çàãîëîâêè
		curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);   // ïåğåõîäèò ïî ğåäèğåêòàì
		curl_setopt($ch, CURLOPT_ENCODING, "");        // îáğàáàòûâàåò âñå êîäèğîâêè
    ...
    {
    	$r_from = array('(',')','ÑĞ½Ğ²Ğ°Ñ€Ñ','Ñ„ĞµĞ²Ñ€Ğ°Ğ»Ñ','Ğ¼Ğ°Ñ€Ñ‚Ğ°','Ğ°Ğ¿Ñ€ĞµĞ»Ñ','Ğ¼Ğ°Ñ','Ğ¸ÑĞ½Ñ','Ğ¸ÑĞ»Ñ','Ğ°Ğ²Ğ³ÑƒÑÑ‚Ğ°','ÑĞµĞ½Ñ‚ÑĞ±Ñ€Ñ','Ğ¾ĞºÑ‚ÑĞ±Ñ€Ñ','Ğ½Ğ¾ÑĞ±Ñ€Ñ','Ğ´ĞµĞºĞ°Ğ±Ñ€Ñ');
