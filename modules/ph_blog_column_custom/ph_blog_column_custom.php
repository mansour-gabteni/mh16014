...
class PH_Blog_Column_Custom extends Module
{
    ...
    protected function initFieldsForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->l('Max width of the image:'),
                    'name' => self::$cfg_prefix.'IMG_MAX_WIDTH',
                    'validation' => 'isUnsignedInt',
                    'suffix' => 'px',
    ...
    public function hookDisplayLeftColumn($params)
    {
        ...
        return $this->display(__FILE__, 'custom_block_column.tpl');
    }
    ...
    /**
     * Important: This hook is not supported by default
     * @param  array $params additional configuration
     * @return mixed view
     */
    public function hookDisplayFooter($params)
    {
        ...
        return $this->display(__FILE__, 'custom_block_column-footer.tpl');
    }
}
