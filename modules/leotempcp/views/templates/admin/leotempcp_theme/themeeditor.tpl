    ...
    <form  enctype="multipart/form-data" action="{$actionURL}" id="form" method="post">
        <div id="leo-customize" class="leo-customize">
            ...
            <div class="wrapper"><div id="customize-form">
                    <p>  
                        <span class="badge">{l s='Theme' mod='leotempcp'}{$themeName}</span>   <a class="label label-default pull-right" href="{$backLink}">{l s='Back' mod='leotempcp'}</a>  
                    </p>        
                    ...
                    <div class="groups">
                        ...
                        <div class="form-group clearfix">
                        <a href="{$imgLink}" class="btn btn btn-default btn-xs" id="upload_pattern">{l s='Upload other pattern' mod='leotempcp'}</a>
                        </div>
                    <hr>
                                                            ...
                                                            <div class="accordion-inner panel-body clearfix">
                                                                {foreach $group.selector as $item}
                                                                    ...
                                                                    {else}
                                                                        <div class="form-group cleafix">
                                                                            <label>{$item.label}</label>
                                                                            <input value="" size="10" name="customize[{$group.match}][]" data-match="{$group.match}" type="text" class="input-setting" data-selector="{$item.selector}" data-attrs="{$item.attrs}"><a href="#" class="clear-bg label label-success">{l s='Clear' mod='leotempcp'}</a>
                                                                        </div>
                                                                    {/if}
