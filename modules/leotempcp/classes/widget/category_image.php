...
class LeoWidgetCategory_image extends LeoWidgetBase {
	...
	public function renderForm( $args, $data ){
        ...
        $selected_cates = "";
        $selected_images = "";
        $image_path   = 'themes/'. _THEME_NAME_ . '/img/icontab/';
	...
	public function renderContent(  $args, $setting ){
        ...
        foreach($catids as $cate_id){
            ...
            $result_cate = $this->getNestedCategories(
                        $images, $cate_id, (int)Context::getContext()->language->id, false, null, true, $sql_filter, $sql_sort);
            $result[] = $result_cate;
    ...
    public static function getNestedCategories($images, $root_category = null, $id_lang = false, $active = true, $groups = null,
