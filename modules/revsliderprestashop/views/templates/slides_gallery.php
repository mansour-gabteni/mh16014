	...
	<div class="wrap settings_wrap">
		...
		<?php if($numSlides >= 5){ ?>
			<a class='button-primary revblue' id="button_new_slide_top" href='javascript:void(0)' ><i class="revicon-list-add"></i><?php echo RevsliderPrestashop::$lang['New_Slide'];  ?></a>

			<a class='button-primary revblue' id="button_new_slide_transparent_top" href='javascript:void(0)' ><i class="revicon-list-add"></i><?php echo RevsliderPrestashop::$lang['New_Transparent'];  ?></a>
		...
		if($useStaticLayers == 'on'){
			?>		
			<a class='button-primary revgray' href='<?php echo self::getViewUrl(RevSliderAdmin::VIEW_SLIDE,"id=static_".$slider->getID()); ?>' style="width:190px; "><i class="eg-icon-dribbble"></i><?php echo RevsliderPrestashop::$lang['Static_Global'];  ?></a>
			<?php
		}
		?>
		<a class="button-primary revyellow" href='<?php echo self::getViewUrl(RevSliderAdmin::VIEW_SLIDERS);?>' ><i class="revicon-cancel"></i><?php echo RevsliderPrestashop::$lang['Close'];  ?></a>		
		<a href="<?php echo $linksSliderSettings?>" class="button-primary revgreen"><i class="revicon-cog"></i><?php echo RevsliderPrestashop::$lang['Slider_Settings'];  ?></a>		
