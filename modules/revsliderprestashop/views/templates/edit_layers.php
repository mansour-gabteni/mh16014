	...
	<div class="edit_slide_wrapper<?php echo ($slide->isStaticSlide()) ? ' rev_static_layers' : ''; ?>">
		...
		if(!$slide->isStaticSlide()){
			...
			<div class="editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important;">
				<h3 class="box-closed tp-accordion">
					<span class="postbox-arrow2">-</span><span><?php echo RevsliderPrestashop::$lang['Slider_Main_Image_bg'];  ?></span>
				</h3>
				<div class="toggled-content">
					<div class="inner_wrapper p10 pb0 pt0 boxsized">
						<div class="editor_buttons_wrapper_top">
							<h3 style="cursor:default !important; background:none !important;border:none;box-shadow:none !important;font-size:12px;padding:0px;margin:10px 0px 0px;"><?php echo RevsliderPrestashop::$lang['Background_Source'];  ?></h3>
							...
							<label style="float:left;margin-left:5px;margin-top:2px;"  for="radio_back_image"><?php echo RevsliderPrestashop::$lang['Image_BG'];  ?></label>
							<!-- THE BG IMAGE CHANGED DIV -->
							<div id="tp-bgimagewpsrc" class="bgsrcchanger-div" style="display:none;float:left;margin-top:-7px;">
								<a href="javascript:void(0)" id="button_change_image" class="button-primary revblue <?php if($bgType != "image") echo "button-disabled" ?>" style="margin-bottom:5px"><?php echo RevsliderPrestashop::$lang['Change_Image'];  ?></a>
							</div>
							...
							<label style="float:left;margin-left:5px;margin-top:2px;"for="radio_back_external"><?php echo RevsliderPrestashop::$lang['External_URL'];  ?></label>
							...
							<div id="tp-bgimageextsrc" class="bgsrcchanger-div" style="display:none;float:left;margin-top:-7px;">
								...
								<a href="javascript:void(0)" id="button_change_external" class="button-primary revblue <?php if($bgType != "external") echo "button-disabled" ?>" style="margin-bottom:5px"><?php echo RevsliderPrestashop::$lang['Get_External'];  ?></a>
							</div>
							...
							<label style="float:left;margin-left:5px;margin-top:2px;"for="radio_back_trans"><?php echo RevsliderPrestashop::$lang['Transparent'];  ?></label>
							...
							<label style="float:left;margin-left:5px;margin-top:2px;"for="radio_back_solid"><?php echo RevsliderPrestashop::$lang['Solid_Colored'];  ?></label>
							...
							<div id="tp-bgimagesettings" class="bgsrcchanger-div" style="margin-top:10px;display:none">
								<div id="bg-setting-wrap">
									<h3 style="cursor:default !important; background:none !important;border:none;box-shadow:none !important;font-size:12px;padding:0px;margin:17px 0px 0px;"><?php echo RevsliderPrestashop::$lang['Background_Settings'];  ?></h3>
									<label for="slide_bg_fit"><?php echo RevsliderPrestashop::$lang['Background_Fit'];  ?></label>
									<select name="bg_fit" id="slide_bg_fit" style="margin-right:20px">
										<option value="cover"<?php if($bgFit == 'cover') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['cover'];  ?></option>
										<option value="contain"<?php if($bgFit == 'contain') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['contain'];  ?></option>
										<option value="percentage"<?php if($bgFit == 'percentage') echo ' selected="selected"'; ?>>(%, %)</option>
										<option value="normal"<?php if($bgFit == 'normal') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['normal'];  ?></option>
									</select>
									...
									<label for="slide_bg_repeat"><?php echo RevsliderPrestashop::$lang['Background_Repeat'];  ?></label>
									...
									<label for="slide_bg_position" id="bg-position-lbl"><?php echo RevsliderPrestashop::$lang['Background_Position'];  ?></label>
									<div id="bg-start-position-wrapper">
										<select name="bg_position" id="slide_bg_position">
											<option value="center top"<?php if($bgPosition == 'center top') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['center_top'];  ?></option>
											<option value="center right"<?php if($bgPosition == 'center right') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['center_right'];  ?></option>
											<option value="center bottom"<?php if($bgPosition == 'center bottom') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['center_bottom'];  ?></option>
											<option value="center center"<?php if($bgPosition == 'center center') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['center_center'];  ?></option>
											<option value="left top"<?php if($bgPosition == 'left top') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['left_top'];  ?></option>
											<option value="left center"<?php if($bgPosition == 'left center') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['left_center'];  ?></option>
											<option value="left bottom"<?php if($bgPosition == 'left bottom') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['left_bottom'];  ?></option>
											<option value="right top"<?php if($bgPosition == 'right top') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['right_top'];  ?></option>
											<option value="right center"<?php if($bgPosition == 'right center') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['right_center'];  ?></option>
											<option value="right bottom"<?php if($bgPosition == 'right bottom') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['right_bottom'];  ?></option>
								...
								<div style="clear:both"></div>
								<h3 style="cursor:default !important; background:none !important;border:none;box-shadow:none !important;font-size:12px;padding:0px;margin:17px 0px 0px; float: left;"><?php echo RevsliderPrestashop::$lang['Pan_Zoom_Settings'];  ?></h3>

								<div style="margin-top: 15px; margin-left: 10px; float: left;">
									<input type="radio" name="kenburn_effect" value="on" <?php echo ($kenburn_effect == 'on') ? 'checked="checked"' : ''; ?> /> <?php echo RevsliderPrestashop::$lang['On'];  ?>&nbsp;&nbsp;<input type="radio" name="kenburn_effect" value="off" <?php echo ($kenburn_effect == 'off') ? 'checked="checked"' : ''; ?> /> <?php echo RevsliderPrestashop::$lang['Off'];  ?>
								</div>
								<div class="clear"></div>

								<table id="kenburn_wrapper" <?php echo ($kenburn_effect == 'off') ? 'style="display: none;"' : ''; ?>>
									<tr>
										<td><?php echo RevsliderPrestashop::$lang['Background'];  ?></td>
										<td></td>
										<td></td>
									...
									<tr>
										<td><?php echo RevsliderPrestashop::$lang['Start_Position'];  ?></td>
										<td colspan="2" id="bg-start-position-wrapper-kb">

										</td>
										<td></td>
										<td><?php echo RevsliderPrestashop::$lang['Start_Fit'];  ?></td>
										<td colspan="2"><input type="text" name="kb_start_fit" value="<?php echo intval($kb_start_fit); ?>" /></td>
										<td></td>
										<td><?php echo RevsliderPrestashop::$lang['Easing'];  ?></td>
										<td>
									...
									<tr>
										<td><?php echo RevsliderPrestashop::$lang['End_Position'];  ?></td>
										<td colspan="2">
											<select name="bg_end_position" id="slide_bg_end_position">
												<option value="center top"<?php if($bgEndPosition == 'center top') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['center_top'];  ?></option>
												<option value="center right"<?php if($bgEndPosition == 'center right') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['center_right'];  ?></option>
												<option value="center bottom"<?php if($bgEndPosition == 'center bottom') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['center_bottom'];  ?></option>
												<option value="center center"<?php if($bgEndPosition == 'center center') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['center_center'];  ?></option>
												<option value="left top"<?php if($bgEndPosition == 'left top') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['left_top'];  ?></option>
												<option value="left center"<?php if($bgEndPosition == 'left center') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['left_center'];  ?></option>
												<option value="left bottom"<?php if($bgEndPosition == 'left bottom') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['left_bottom'];  ?></option>
												<option value="right top"<?php if($bgEndPosition == 'right top') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['right_top'];  ?></option>
												<option value="right center"<?php if($bgEndPosition == 'right center') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['right_center'];  ?></option>
												<option value="right bottom"<?php if($bgEndPosition == 'right bottom') echo ' selected="selected"'; ?>><?php echo RevsliderPrestashop::$lang['right_bottom'];  ?></option>
										...
										<td></td>
										<td><?php echo RevsliderPrestashop::$lang['End_Fit'];  ?></td>
										<td colspan="2"><input type="text" name="kb_end_fit" value="<?php echo intval($kb_end_fit); ?>" /></td>
										
										<td></td>
										<td><?php echo RevsliderPrestashop::$lang['Duration'];  ?></td>
		...
		<div class="editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important;">
			<h3 class="box-closed tp-accordion">
				<span><?php
				 if($slide->isStaticSlide()){
				  echo RevsliderPrestashop::$lang['Static_Layers']; 
				}else{
				 echo RevsliderPrestashop::$lang['Slide']; 
				 } 
				?></span>
			</h3>
			<div class="layer-editor-toolbar">
				<span class="setting_text_3"><?php echo RevsliderPrestashop::$lang['Helper_Grid'];  ?></span>
				<select name="rs-grid-sizes" id="rs-grid-sizes">
					<option value="1"><?php echo RevsliderPrestashop::$lang['Disabled'];  ?></option>
				...
				<span class="setting_text_3"><?php echo RevsliderPrestashop::$lang['Snap_to'];  ?></span>
				<select name="rs-grid-snapto" id="rs-grid-snapto">
					<option value=""><?php echo RevsliderPrestashop::$lang['None'];  ?></option>
					<option value=".helplines"><?php echo RevsliderPrestashop::$lang['Help_Lines'];  ?></option>
					<option value=".slide_layer"><?php echo RevsliderPrestashop::$lang['Layers'];  ?></option>
				</select>
				...
				if($slide->isStaticSlide()){
					...
					?>
					<span class="setting_text_3"><?php echo RevsliderPrestashop::$lang['Show_Layers_from_Slide'];  ?></span>
				...
				<div class="inner_wrapper p10 pb0 pt0 boxsized">
					...
					<div class="editor_buttons_wrapper_bottom">
						<div style="float:left">
							<a href="javascript:void(0)" id="button_add_layer" 		 data-isstatic="<?php echo $add_static; ?>" class="button-primary revblue"><i class="revicon-layers-alt"></i><?php echo RevsliderPrestashop::$lang['Add_Layer'];  ?></a>
							<a href="javascript:void(0)" id="button_add_layer_image" data-isstatic="<?php echo $add_static; ?>" class="button-primary revblue"><i class="revicon-picture-1"></i><?php echo RevsliderPrestashop::$lang['Add_Layer_Image'];  ?> </a>
							<a href="javascript:void(0)" id="button_add_layer_video" data-isstatic="<?php echo $add_static; ?>" class="button-primary revblue"><i class="revicon-video"></i><?php echo RevsliderPrestashop::$lang['Add_Layer_Video'];  ?> </a>
							<a href="javascript:void(0)" id="button_duplicate_layer" class="button-primary revyellow button-disabled"><i class="revicon-picture"></i><?php echo RevsliderPrestashop::$lang['Duplicate_Layer'];  ?></a>
						</div>
						<div style="float:right;">
							<a href="javascript:void(0)" id="button_delete_layer"    class="button-primary  revred button-disabled"><i class="revicon-trash"></i><?php echo RevsliderPrestashop::$lang['Delete_Layer'];  ?></a>
							<a href="javascript:void(0)" id="button_delete_all"      class="button-primary  revred button-disabled"><i class="revicon-trash"></i><?php echo RevsliderPrestashop::$lang['Delete_All_Layers'];  ?> </a>
						</div>
					</div>
				</div>
				<div class="clear"></div>
				...
				<div class="edit_layers_right" style="position:relative;height:100%">
					<div class="postbox unite-postbox layer_sortbox" style="height:100%;">
						...
						<h3 class="no-accordion">
							<span><?php echo RevsliderPrestashop::$lang['Layers_Timing_Sorting'];  ?></span>																																				
						</h3>
						<div style="display:table; line-height:30px">
							<div style="display:table-cell; padding:10px 15px; min-width:45px;"><?php echo RevsliderPrestashop::$lang['z_Index'];  ?></div>
							<div style="display:table-cell; min-width:78px">
								<div id="button_sort_visibility" class="tipsy_enabled_top" title="<?php echo RevsliderPrestashop::$lang['Hide_All_Layers'];  ?>"><i class="eg-icon-eye"></i><i class="eg-icon-eye-off"></i></div>
								<div id="button_sort_lock" class="tipsy_enabled_top" title="<?php echo RevsliderPrestashop::$lang['Lock_All_Layers'];  ?>"><i class="eg-icon-lock-open"></i><i class="eg-icon-lock"></i></div>	
								<div id="button_sort_tillend" class="tipsy_enabled_top" title="<?php echo RevsliderPrestashop::$lang['Snap_to_Slide'];  ?>"><i class="eg-icon-back-in-time"></i></div>											
							</div>
							<div style="display:table-cell;padding:10px 15px 10px 0px;width:100%"><?php echo RevsliderPrestashop::$lang['Timing'];  ?>
								<div id="button_sort_timing" class="button-primary revblue" style="margin-left:15px !important" title="<?php echo RevsliderPrestashop::$lang['sh_Timer_Settings'];  ?>"><i class="eg-icon-equalizer"></i> <span class="onoff"> - on</span></div>
							</div>									
							<div style="display:table-cell;padding:10px 0px 10px 0px; min-width:50px;"><?php echo RevsliderPrestashop::$lang['Start'];  ?></div>									
							<div style="display:table-cell;padding:10px 0px 10px 0px; min-width:54px;"><?php echo RevsliderPrestashop::$lang['End'];  ?></div>																		
						</div>									
				...
				<div class="edit_layers_left">
					...
					<form name="form_layers" id="form_layers">
						...
						<div class='settings_wrapper' style="<?php echo $show_static; ?>">
							<div class="postbox unite-postbox">
								<h3 class='no-accordion tp-accordion'><span class="postbox-arrow2">-</span>
									<span><?php echo RevsliderPrestashop::$lang['Static_Options'];  ?> </span>
								</h3>
								<div class="toggled-content tp-closeifotheropen">
									<ul class="list_settings">
										...
										if($isTemplate == "true"){
											?>
											<li>
											<?php echo RevsliderPrestashop::$lang['Static_Options_desc'];  ?>
											</li>
											<?php
										}
										?>
										<div id="layer_static_wrapper"<?php echo ($isTemplate == "true") ? ' style="display: none;"' : ''; ?>>
											<li>
												<div id="static_start_on_wrap" class="setting_text"><?php echo RevsliderPrestashop::$lang['Start_on_Slide'];  ?></div>
											...
											<div class="clear"></div>
											<li>
												<div id="static_end_on_wrap" class="setting_text"><?php echo RevsliderPrestashop::$lang['End_on_Slide'];  ?></div>
						...
						<div class='settings_wrapper'>
							<div class="postbox unite-postbox">
								<h3 class='no-accordion tp-accordion'><span class="postbox-arrow2">-</span>
									<span><?php echo RevsliderPrestashop::$lang['Layer_General_Parameters'];  ?> </span>
								</h3>
								<div class="toggled-content tp-closeifotheropen">
									<ul class="list_settings">
										<li id="end_layer_sap" class="attribute_title" style="margin-top:-10px;">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Layer_Content'];  ?></span>
										</li>
										<?php
										...
										?>
										<li style="clear:both">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Position_Styling'];  ?></span>
										</li>
										...
										<li id="layer_scale_title_row" style="clear:both;">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Image_Scale'];  ?></span>
										</li>
										<a id="reset-scale" class="revred button-primary" href="javascript:void(0);"><?php echo RevsliderPrestashop::$lang['Reset_Size']; ?></a>
										<?php
										...
										<li id="layer_2d_title_row" style="clear:both;">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Final_Rotation'];  ?></span>
										</li>
										<div style="clear: both;">
											<?php
										...
										<div id="parallax_wrapper_div" style="<?php echo $show_parallax; ?>">
											<li id="parallax_title_row" style="clear:both;">
												<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Parallax_Setting'];  ?></span>
											</li>
											<?php
						...
						<div class='settings_wrapper'>
							<div class="postbox unite-postbox">
								<h3 class='no-accordion tp-accordion tpa-closed'><span class="postbox-arrow2">+</span>
									<span><?php echo RevsliderPrestashop::$lang['Layer_Animation'];  ?> </span>
								</h3>
								<div class="toggled-content tp-closedatstart tp-closeifotheropen">
									<ul class="list_settings">
										...
										<li id="end_layer_sap" class="attribute_title" style="margin-top:-10px;">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Preview_Transition'];  ?></span>
										</li>
										<div id="preview_caption_transition">

											<div class="preview_caption_wrapper">
												<div id="preview_caption_animateme"><?php echo RevsliderPrestashop::$lang['LAYER_EXAMPLE'];  ?></div>
											</div>

											<div id="preview_looper"><i class="revicon-arrows-ccw"></i><span class="replyinfo"><?php echo RevsliderPrestashop::$lang['on'];  ?></span></div>
										</div>
										...
										<li id="end_layer_sap" class="attribute_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Start_Transition'];  ?></span>
										</li>
										<div class="layer-animations">
											...
											<a href="javascript:void(0)" id="add_customanimation_in" 	class="button-primary revblue"><i class="revicon-equalizer"></i><?php echo RevsliderPrestashop::$lang['Custom_Animation'];  ?></a>
											<div class="clear"></div>
											<?php
										...
										<!--LAYER END ANIMATION -->
										<li id="end_layer_sap" class="attribute_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['End_Transition_opt'];  ?></span>
										</li>
										<div class="layer-animations">
										<div style="float:left;margin-right:10px;"><?php
											...
											<a href="javascript:void(0)" id="add_customanimation_out" 	class="button-primary revblue"><i class="revicon-equalizer"></i><?php echo RevsliderPrestashop::$lang['Custom_Animation'];  ?></a>
											<div class="clear"></div>
											<?php
										...
										<li id="loop_layer_sap" class="attribute_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Loop_Animation'];  ?></span>
										</li>
										<?php
						...
						<div id="layeranimeditor_wrap" title="Layer Animation Editor" style="display:none;margin-bottom:0px; padding-bottom:0px;">
							<div class="tp-present-wrapper-parent">
								<div class="tp-present-wrapper">
									<div class="tp-present-caption">
										<div id="caption_custon_anim_preview" class=""><?php echo RevsliderPrestashop::$lang['LAYER_EXAMPLE'];  ?></div>
									</div>
								</div>
							</div>
							...
							<div class="settings_wrapper">
								<div class="postbox unite-postbox">
									<h3 class="no-accordion tp-accordion">
										<span style="font-size:13px;padding-left:4px;"><i class="revicon-equalizer"></i><?php echo RevsliderPrestashop::$lang['Anim_Settings_Panel'];  ?></span>
										<span style="float: right;"><a href="javascript:void(0);" style="margin-top:-7px;border: none;font-weight: 400;box-shadow: none;-webkit-box-shadow: none;-moz-box-shadow: none;" id="set-random-animation" class="button-primary revgreen"><i class="eg-icon-shuffle"></i><?php echo RevsliderPrestashop::$lang['Randomize'];  ?></a></span>
									</h3>

									<table style="border-spacing:0px">

										<!-- TRANSITION -->
										<tr class="css-edit-title graybasicbg" ><td colspan="6" style="padding:10px"><?php echo RevsliderPrestashop::$lang['Transition'];  ?></td></tr>
										...
										<tr class="css-edit-title"><td colspan="6" style="padding:10px"><?php echo RevsliderPrestashop::$lang['Rotation'];  ?></td></tr>
										<tr>
											<td><?php _e("X:",REVSLIDER_TEXTDOMAIN) ?></td>
											<td style="padding-bottom:15px">
									...
									<table style="border-spacing:0px">
										...
										<tr class="css-edit-title graybasicbg">
											<td colspan="4" style="padding:10px"><?php echo RevsliderPrestashop::$lang['Scale'];  ?></td>
											<td colspan="4" style="padding:10px;padding-left:20px"><?php echo RevsliderPrestashop::$lang['Skew'];  ?></td>
										</tr>
									...
									<table style="border-spacing:0px padding-bottom:10px">
										...
										<tr class="css-edit-title">
											<td colspan="2" style="padding:10px"><?php echo RevsliderPrestashop::$lang['Opacity'];  ?></td>
											<td colspan="2" style="padding:10px;padding-left:20px"><?php echo RevsliderPrestashop::$lang['Perspective'];  ?></td>
											<td colspan="2" style="padding:10px;padding-left:20px"><?php echo RevsliderPrestashop::$lang['Origin'];  ?></td>
										</tr>
							...
							<div class="settings_wrapper">
								<div class="postbox unite-postbox">
									<h3 class="no-accordion tp-accordion">
										<span style="font-size:13px;padding-left:4px;"><i class="eg-icon-tools"></i><?php echo RevsliderPrestashop::$lang['Test_Parameters'];  ?></span>
										<span style="font-size: 9px;text-align: right;font-weight: 300;font-style: italic;white-space: nowrap;"><?php echo RevsliderPrestashop::$lang['Test_Parameters_desc'];  ?></span>
									</h3>

										<table>
											<tr>
												<td><?php echo RevsliderPrestashop::$lang['Speed'];  ?>:</td>
										...
										<div id="caption-inout-controll" class="caption-inout-controll">
											<i id="revshowmetheinanim" class="revicon-login reviconinaction"></i><i id="revshowmetheoutanim" class="revicon-logout"></i><?php echo RevsliderPrestashop::$lang['Transition_Direction'];  ?>
										</div>
						...
						<div id="dialog-change-layeranimation" title="Save Layer Animation" style="display:none;">
							...
							echo RevsliderPrestashop::$lang['Overwrite_Animation'];
							echo '"<span id="current-layer-handle"></span>"';
							echo RevsliderPrestashop::$lang['new_Animation'];  
							?></p>
						</div>

						<div id="dialog-change-layeranimation-save-as" title="Save as" style="display:none;">
							<p>
								<?php echo RevsliderPrestashop::$lang['Save_Animation'];  ?><br />
						...
						<div class='settings_wrapper'>
							<div class="postbox unite-postbox">
								<h3 class='no-accordion tp-accordion tpa-closed'><span class="postbox-arrow2">+</span>
									<span><?php echo RevsliderPrestashop::$lang['Advanced_Params'];  ?> </span>
								</h3>
								<div class="toggled-content tp-closedatstart tp-closeifotheropen">

									<ul class="list_settings">
										<li class="custom attributes_title" style="margin-top:-10px;">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Links_optional'];  ?></span>
											<!--<hr>-->
										</li>
										...
										<li id="" class="custom attributes_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Caption_Sharp'];  ?></span>
											<!--<hr>-->
										</li>
										<div class="layer-links">
											<?php
										...
										<li id="" class="custom attributes_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Responsive_Settings'];  ?></span>
										</li>
										<div class="layer-links">
											<?php
												$s = $settingsLayerOutput;
										...
										<li id="custom_attributes" class="custom attributes_title" style="">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo RevsliderPrestashop::$lang['Attributes_opt'];  ?></span>
										</li>
										<?php
											$s = $settingsLayerOutput;
	...
	<div id="dialog_template_insert" class="dialog_template_help" title="<?php echo RevsliderPrestashop::$lang['Template_Insertions'];  ?>" style="display:none;">
		<b><?php echo RevsliderPrestashop::$lang['Post_Placeholders'];  ?></b>
		<table class="table_template_help">
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('product:somemegatag')">%product:somemegatag%</a></td><td><?php echo RevsliderPrestashop::$lang['Any_custom_Tag'];  ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('title')">%title%</a></td><td><?php echo RevsliderPrestashop::$lang['Product_Name'];  ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('product_price')">%product_price%</a></td><td><?php echo RevsliderPrestashop::$lang['Product_Price'];  ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('description_short')">%description_short%</a></td><td><?php echo RevsliderPrestashop::$lang['Product_Srt_Desc'];  ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('description')">%description%</a></td><td><?php echo RevsliderPrestashop::$lang['Product_Description'];  ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('link')">%link%</a></td><td><?php echo RevsliderPrestashop::$lang['link_Product'];  ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('addtocart')">%addtocart%</a></td><td><?php echo RevsliderPrestashop::$lang['link_Product_Cart'];  ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('category_default')">%category_default%</a></td><td><?php echo RevsliderPrestashop::$lang['Product_Cat_Default'];  ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('date')">%date%</a></td><td><?php echo RevsliderPrestashop::$lang['Date_created'];  ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('date_modified')">%date_modified%</a></td><td><?php echo RevsliderPrestashop::$lang['Date_modified'];  ?></td></tr>
			<tr><td><a href="javascript:UniteLayersRev.insertTemplate('countdown')">%countdown%</a></td><td><?php echo RevsliderPrestashop::$lang['Specials_CountDown'];  ?></td></tr>
			<?php
			$extra_hook_meta = array();
			Hook::exec('actionsdsrevinsertmeta',array(
				'extra_hook_meta' => &$extra_hook_meta
			));
			if(isset($extra_hook_meta) && !empty($extra_hook_meta)){
				?>
</table><br><br>
<b><?php echo RevsliderPrestashop::$lang['Custom_Placeholders'];  ?></b>
<table class="table_template_help">
				<?php
				foreach ($extra_hook_meta as $svalue){
					?>
<tr><td><a href="javascript:UniteLayersRev.insertTemplate('<?php echo $svalue['title']; ?>')">%<?php echo $svalue['title']; ?>%</a></td><td><?php echo $svalue['description']; ?></td></tr>
<?php } ?>
</table>
<?php } ?>
		</table>
