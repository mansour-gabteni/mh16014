...
?>
	...
	<div id="api_wrapper" class="api_wrapper postbox unite-postbox ">
			...
			<h3 class="box_closed tp-accordion tpa-closed"><div class="postbox-arrow"></div><span><?php echo RevsliderPrestashop::$lang['API_Functions'];  ?> </span></h3>

			<div class="toggled-content tp-closedatstart p20">

					<div class="api-caption"><?php echo RevsliderPrestashop::$lang['API_Methods'];  ?>:</div>

					<div class="divide20"></div>

					<div class="api-desc"><?php echo RevsliderPrestashop::$lang['copy_paste_js'];  ?>. </div>
					...
					<table class="api-table">
						...
						<tr>
							...
							<td class="api-cell1"><?php echo RevsliderPrestashop::$lang['Pause_Slider'];  ?>:</td>
						...
						<tr>
							...
							<td class="api-cell1"><?php echo RevsliderPrestashop::$lang['Resume_Slider'];  ?>:</td>
						...
						<tr>
							...
							<td class="api-cell1"><?php echo RevsliderPrestashop::$lang['Previous_Slide'];  ?>:</td>
						...
						<tr>
							...
							<td class="api-cell1"><?php echo RevsliderPrestashop::$lang['Next_Slide'];  ?>:</td>
						...
						<tr>
							...
							<td class="api-cell1"><?php echo RevsliderPrestashop::$lang['Go_To_Slide'];  ?>:</td>
						...
						<tr>
							...
							<td class="api-cell1"><?php echo RevsliderPrestashop::$lang['Num_Slides'];  ?>:</td>
						...
						<tr>
							...
							<td class="api-cell1"><?php echo RevsliderPrestashop::$lang['Slide_Number'];  ?>:</td>
						...
						<tr>
							...
							<td class="api-cell1"><?php echo RevsliderPrestashop::$lang['Playing_Slide'];  ?>:</td>
						...
						<tr>
							...
							<td class="api-cell1"><?php echo RevsliderPrestashop::$lang['External_Scroll'];  ?>:</td>
						...
						<tr>
							...
							<td class="api-cell1"><?php echo RevsliderPrestashop::$lang['Redraw_Slider'];  ?>:</td>
					...
					<div class="api-caption"><?php echo RevsliderPrestashop::$lang['API_Events'];  ?>:</div>

					<div class="divide20"></div>

					<div class="api-desc"><?php echo RevsliderPrestashop::$lang['jQuery_Functions'];  ?>.</div>
