	<div class="wrap settings_wrap">
		...
		<div class="title_line">
			...
			<h2><?php echo RevsliderPrestashop::$lang['Edit_Slides'];  ?>: <?php echo $slider->getTitle()?></h2>
		...
		<?php if($numSlides >= 5):?>
			<a class='button-primary' id="button_new_slide_top" href='javascript:void(0)' ><?php echo RevsliderPrestashop::$lang['New_Slide'];  ?></a>
			<span class="hor_sap"></span>
			<a class='button-primary' id="button_new_slide_transparent_top" href='javascript:void(0)' ><?php echo RevsliderPrestashop::$lang['New_Transparent'];  ?></a>
			...
			<a class="button_close_slide button-primary mright_20" href='<?php echo self::getViewUrl(RevSliderAdmin::VIEW_SLIDERS);?>' ><?php echo RevsliderPrestashop::$lang['Close'];  ?></a>
		<?php endif?>
		...
		<a class='button-primary' id="button_new_slide" data-dialogtitle="<?php echo RevsliderPrestashop::$lang['Select_image'];  ?>" href='javascript:void(0)' ><?php echo RevsliderPrestashop::$lang['New_Slide'];  ?></a>
		<span class="hor_sap"></span>		
		<a class='button-primary' id="button_new_slide_transparent" href='javascript:void(0)' ><?php echo RevsliderPrestashop::$lang['New_Transparent'];  ?></a>
		<span class="loader_round new_trans_slide_loader" style="display:none"><?php echo RevsliderPrestashop::$lang['Adding_Slide'];  ?></span>
		<?php
		if($useStaticLayers == 'on'){
			?>	
			<span class="hor_sap_double"></span>
			<a class='button-primary revgray' href='<?php echo self::getViewUrl(RevSliderAdmin::VIEW_SLIDE,"id=static"); ?>' style="width:190px; "><i style="color:#fff" class="eg-icon-dribbble"></i><?php echo RevsliderPrestashop::$lang['Static_Global'];  ?></a>
			<?php
		}
		?>
		<span class="hor_sap_double"></span>
		<a class="button_close_slide button-primary" href='<?php echo self::getViewUrl(RevSliderAdmin::VIEW_SLIDERS);?>' ><?php echo RevsliderPrestashop::$lang['Close'];  ?></a>
		<span class="hor_sap"></span>
		<a href="<?php echo $linksSliderSettings?>" id="link_slider_settings"><?php echo RevsliderPrestashop::$lang['To_Settings'];  ?></a>
	</div>
