...
<div id="dialog_video" class="dialog-video" title="<?php echo RevsliderPrestashop::$lang['Add_Video_Layout'];  ?>" style="display:none">
	...
	<!-- Type chooser -->
		...
		<div id="video_type_chooser" class="video-type-chooser">
			...
			<div class="choose-video-type" style="float:left">
				...
				<?php echo RevsliderPrestashop::$lang['Choose_video_type'];  ?>

			</div>

			<div style="float:left; height:35px;line-height:15px;margin-top:20px;margin-left:30px">

				<label for="video_radio_youtube"><?php echo RevsliderPrestashop::$lang['Youtube'];  ?></label>

				<input type="radio" checked id="video_radio_youtube" name="video_select">

				

				<label for="video_radio_vimeo"><?php echo RevsliderPrestashop::$lang['Vimeo'];  ?></label>

				<input type="radio" id="video_radio_vimeo" name="video_select">

				

				<label for="video_radio_html5"><?php echo RevsliderPrestashop::$lang['HTML5'];  ?></label>
	...
	<div class="video_left" id="video-dialog-wrap">
		...
		<div id="video_block_vimeo" class="video-select-block" style="display:none;" >
			...
			<div class="video-title" >
				...
				<?php echo RevsliderPrestashop::$lang['Vimeo_ID_URL'];  ?>
			...
			<div class="video_example">
				...
				<?php echo RevsliderPrestashop::$lang['example_30300114'];  ?>
		...
		<div id="video_block_youtube" class="video-select-block">
			...
			<div class="video-title">
				...
				<?php echo RevsliderPrestashop::$lang['Youtube_ID_URL'];  ?>:
			...
			<div class="video_example">
				...
				<?php echo RevsliderPrestashop::$lang['example'];  ?>:  <?php echo GlobalsRevSlider::YOUTUBE_EXAMPLE_ID?>
		...
		<div id="video_block_html5" class="video-select-block" style="display:none;">
			...
			<ul>
				...
				<li style="width:45%;float:left;">
					...
					<?php echo RevsliderPrestashop::$lang['Poster_Image_Url'];  ?>:

					</div>

					<input type="text" id="html5_url_poster" value=""></input>

					<span class="video_example"><?php echo RevsliderPrestashop::$lang['Example'];  ?>: http://video-js.zencoder.com/oceans-clip.png</span>
				...
				<li style="width:45%;float:left;margin-left:4%;">
					...
					<?php echo RevsliderPrestashop::$lang['Video_MP4_Url'];  ?>:

					</div>

					<input type="text" id="html5_url_mp4" value=""></input>

					<span class="video_example"><?php echo RevsliderPrestashop::$lang['Example'];  ?>: http://video-js.zencoder.com/oceans-clip.mp4</span>
				...
				<li style="clear:both;width:45%;float:left;margin-top:20px;">
					...
					<?php echo RevsliderPrestashop::$lang['Video_WEBM_Url'];  ?>:

					</div>

					<input type="text" id="html5_url_webm" value=""></input>

					<span class="video_example"><?php echo RevsliderPrestashop::$lang['Example'];  ?>: http://video-js.zencoder.com/oceans-clip.webm</span>					
				...
				<li style="width:45%;float:left;margin-left:4%;margin-top:20px;">
					...
					<?php echo RevsliderPrestashop::$lang['Video_OGV_Url'];  ?>:

					</div>			

					<input type="text" id="html5_url_ogv" value=""></input>

					<span class="video_example"><?php echo RevsliderPrestashop::$lang['Example'];  ?>: http://video-js.zencoder.com/oceans-clip.ogv</span>	
		...
		<div id="video_hidden_controls" style="display:none; margin-top:20px;">
			...
			<div class="video-title">
				...
				<?php echo RevsliderPrestashop::$lang['Video_Size'];  ?>:
			...
			<div id="video_size_wrapper" class="youtube-inputs-wrapper">
				...
				<label for="input_video_fullwidth" class=" float_left mtop_10">
					...
					<?php echo RevsliderPrestashop::$lang['Full_Width'];  ?>
				...
				<div class="float_left mleft_20 mtop_10" id="input_video_width_lbl"><?php echo RevsliderPrestashop::$lang['Width'];  ?>:</div>

				<input type="text" id="input_video_width" style="margin-top:5px;" class="video-input-small float_left" value="320">

				

				<div class="float_left mleft_20 mtop_10" id="input_video_height_lbl"><?php echo RevsliderPrestashop::$lang['Height'];  ?>:</div>
				...
				<div id="fullscreenvideofun" class="mtop_20">
					...
					<label for="input_video_cover" class="float_left">
						...
						<?php echo RevsliderPrestashop::$lang['Cover'];  ?>
					...
					<label for="input_video_dotted_overlay" class="float_left mleft_20" id="input_video_dotted_overlay_lbl">
						...
						<?php echo RevsliderPrestashop::$lang['Dotted_Overlay'];  ?>
					</label>				

					<select id="input_video_dotted_overlay" style="float: left; margin-top:-5px">

						<option value="none"><?php echo RevsliderPrestashop::$lang['none'];  ?></option>

						<option value="twoxtwo"><?php echo RevsliderPrestashop::$lang['2_2_Black'];  ?></option>

						<option value="twoxtwowhite"><?php echo RevsliderPrestashop::$lang['2_2_White'];  ?></option>

						<option value="threexthree"><?php echo RevsliderPrestashop::$lang['3_3_Black'];  ?></option>

						<option value="threexthreewhite"><?php echo RevsliderPrestashop::$lang['3_3_White'];  ?></option>
					...
					<label for="input_video_ratio" class="float_left mleft_20" id="input_video_ratio_lbl">
						...
						<?php echo RevsliderPrestashop::$lang['Aspect_Ratio'];  ?>
					</label>				

					<select id="input_video_ratio" style="margin-top:-10px">

						<option value="16:9"><?php echo RevsliderPrestashop::$lang['16_9'];  ?></option>

						<option value="4:3"><?php echo RevsliderPrestashop::$lang['4_3'];  ?></option>
			...
			<div class="mtop_20">
				...
				<div class="video-title">
					...
					<?php echo RevsliderPrestashop::$lang['Video_Settings'];  ?>:
				...
				<label for="input_video_loop" class=" float_left mtop_10">
					...
					<?php echo RevsliderPrestashop::$lang['Loop_Video'];  ?>
				...
				<label for="input_video_autoplay" class="float_left mtop_10 mleft_20">
					...
					<?php echo RevsliderPrestashop::$lang['Autoplay'];  ?>
				...
				<div id="showautoplayfirsttime" class="float_left">
					...
					<label for="input_video_autoplay_first_time" class="float_left mtop_10 mleft_20">
						...
						<?php echo RevsliderPrestashop::$lang['Only_1st_Time'];  ?>
					</label>
				...
				<label for="input_video_nextslide" class="float_left mtop_10">
					...
					<?php echo RevsliderPrestashop::$lang['Next_Slide_End'];  ?>
				...
				<label for="input_video_force_rewind" class="float_left mtop_10 mleft_20">
					...
					<?php echo RevsliderPrestashop::$lang['Force_Rewind'];  ?>
				...
				<label for="input_video_control" class="float_left mtop_10">
					...
					<?php echo RevsliderPrestashop::$lang['Hide_Controls'];  ?>
				...
				<label for="input_video_mute" class="float_left mleft_20 mtop_10">
					...
					<?php echo RevsliderPrestashop::$lang['Mute'];  ?>
			...
			<div class="video-title mtop_20" id="preview-image-video-wrap">
				...
				<div class="video-title">
					...
					<?php echo RevsliderPrestashop::$lang['Preview_Image'];  ?>:

				</div>



				<input type="button" id="" class="button-image-select-video button-primary revblue" value="<?php echo RevsliderPrestashop::$lang['Set'];  ?>">

				<input type="button" id="" class="button-image-remove-video button-primary revblue" value="<?php echo RevsliderPrestashop::$lang['Remove'];  ?>">
			...
			<div class="video-title mtop_20">
				...
				<?php echo RevsliderPrestashop::$lang['Arguments'];  ?>
			...
			<div class="add-button-wrapper">
				...
				<a href="javascript:void(0)" class="button-primary revblue" id="button-video-add" data-textadd="<?php echo RevsliderPrestashop::$lang['Add_This_Video'];  ?>" data-textupdate="<?php echo RevsliderPrestashop::$lang['Update_Video'];  ?>" ><?php echo RevsliderPrestashop::$lang['Add_This_Video'];  ?></a>
