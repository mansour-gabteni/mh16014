    ...
    $.ajax({
        ...
        success:function (jsonData) {
            if (jsonData.hasError) {
                ...
                var wrapper_el = $('#shopping_cart, #cart_block');
...
function setPaymentModuleHandler() {
    ...
    var sel = $('form#paypalpro_form input#paypalpro_submit, form[name=cs_cardsave_direct_form] input#asubmit, form#stripe-payment-form .stripe-submit-button, form#authorizeaim_form input#asubmit, form#braintree-payment-form input[name=submitPayment]');
...
//        console.info(s1);
    ...
    $('.payment_module').not($('a#click_cs_cardsave_direct').parent()).not($('form#stripe-payment-form').parent()).not($('div#braintree-form').parent()).unbind('click').click(_payment_module_handler);
